...
\newcommand{\RollNo}{\dashfill}
\newcommand{\RegistrationNo}{24026122}
...
\newcommand{\SubmissionDate}{\dashfill}
\newcommand{\DRRCApprovalDate}{\dashfill}
...
\input{titlepage}          % (i)
\input{toc}                % (ii)
\input{listoffigures}      % (iii)
\input{listoftables}       % (iv)
\input{listofappendices}   % (v)
